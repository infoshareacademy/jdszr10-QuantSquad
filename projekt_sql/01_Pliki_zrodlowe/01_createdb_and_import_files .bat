@REM this is script working in Windows system (but it should be enough to change path in COPY lines, and have createdb/psql in execution path)
createdb -U postgres happiness
@REM download files from https://www.kaggle.com/datasets/unsdsn/world-happiness

@REM year2015
@REM Columns: Country,Region,Happiness Rank,Happiness Score,Standard Error,Economy (GDP per Capita),Family,Health (Life Expectancy),Freedom,Trust (Government Corruption),Generosity,Dystopia Residual
...
@REM year2016
@REM Columns: Country,Region,Happiness Rank,Happiness Score,Lower Confidence Interval,Upper Confidence Interval,Economy (GDP per Capita),Family,Health (Life Expectancy),Freedom,Trust (Government Corruption),Generosity,Dystopia Residual
...
@REM year2017
@REM Columns: "Country","Happiness.Rank","Happiness.Score","Whisker.high","Whisker.low","Economy..GDP.per.Capita.","Family","Health..Life.Expectancy.","Freedom","Generosity","Trust..Government.Corruption.","Dystopia.Residual"
...
@REM year2018
@REM Columns: Overall rank,Country or region,Score,GDP per capita,Social support,Healthy life expectancy,Freedom to make life choices,Generosity,Perceptions of corruption
